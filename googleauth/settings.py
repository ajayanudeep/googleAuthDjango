...
SECRET_KEY = 'django-insecure-1!rewazd!-m-%57adt=%q5xx5exvh4-tnimw39vykty9jpz9wy'
...
INSTALLED_APPS = [
    ...
    # These are the required apps for allauth google authentication
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            #specifies the path to templates
